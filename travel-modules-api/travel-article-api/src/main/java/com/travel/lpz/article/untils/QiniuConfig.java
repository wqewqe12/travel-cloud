...
public class qiniu {
    ...
    private static final String accessKey = "1olb214-QrjyM5d0W6CBZIgTNz63XkajMFirl9Jj2f";
    private static final  String secretKey = "5213123R-sDBZ9hmaAtlgYAJLZ8s1pQO0VwXuvDy3";
    /**
     * 获取bucket里面所有文件的信息
     * @param bucketNm
     */
